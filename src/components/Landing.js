...
//         innerMeshRef.current.rotation.z = Math.sin(state.clock.elapsedTime * 0.2) * 0.05;
//       }
...
//       <pointLight position={[-10, -10, -10]} intensity={0.6} color="#B8860B" />
//     </group>
//   );
// };
...
//         if (title) {
//           setTimeout(() => {
//             title.style.minHeight = '2em'; // Increased to accommodate full text
...
//         style={{
//           display: 'grid',
//           gridTemplateColumns: window.innerWidth > 768 ? 'minmax(450px, 1fr) minmax(450px, 1fr)' : '1fr', // Adjusted for more text space
//           alignItems: 'center',
//           gap: '60px',
//           maxWidth: '1200px',
//           width: '100%',
...
//         <div
//           style={{
//             minWidth: window.innerWidth > 768 ? '450px' : '350px', // Slightly reduced to balance layout
...
//             style={{
//               fontSize: window.innerWidth > 768 ? '2.8rem' : '2rem', // Reduced font size for better fit
//               fontWeight: '700',
//               background: 'linear-gradient(135deg, #FFD700, #B8860B)',
...
//               letterSpacing: '1px',
//               lineHeight: '1.2',
//               minHeight: '2em', // Increased to ensure full text visibility
...
//             style={{
//               fontSize: '1.2rem', // Slightly reduced for consistency
//               color: '#F0E68C',
//               marginBottom: '40px',
//               lineHeight: '1.6',
//               maxWidth: '500px',
